...
def get_database_url():
    ...
    if not database_url:
        ...
        database_url = info_admin_panel["database_url"]
    return database_url
...
config.set_section_option(section, "POSTGRES_URI", database_url)
...
target_metadata = database.models.mapper_registry.metadata
